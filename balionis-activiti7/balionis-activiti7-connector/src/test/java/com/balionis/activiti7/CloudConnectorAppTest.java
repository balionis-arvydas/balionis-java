...
import com.balionis.activiti7.connectors.ExampleMessage;
...
@SpringBootTest
public class CloudConnectorAppTest {
    ...
    public void shouldConvertExpectedJsonToPojo() throws IOException {
        ...
        ExampleMessage exampleMessage = objectMapper.convertValue(jsonValue, ExampleMessage.class);
