...
@Component
@EnableBinding(ExampleConnector.Channels.class)
public class ExampleConnector {
    ...
    public void performTask(IntegrationRequest event) throws InterruptedException {
        ...
        if(jsonVar != null){
            ...
            ExampleMessage exampleMessage = objectMapper.convertValue(jsonVar, ExampleMessage.class);
            results.put("test_json_variable_result","able to convert test_json_variable_name to "+ ExampleMessage.class.getName());
        }
